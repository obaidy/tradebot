// Shared mobile API contracts consumed by both the backend BFF (src/mobile)
// and client surfaces (apps/mobile, optionally the portal). Keeping these
// definitions central reduces drift across surfaces when payloads evolve.
