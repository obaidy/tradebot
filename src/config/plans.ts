...
export const PLAN_DEFINITIONS: PlanDefinition[] = [
  ...
  },
  {
    ...
    strategies: ['grid', 'mev', 'dex-swap', 'perp-grid', 'dex-aggregation', 'yield-farming', 'flash-loan-arb', 'cross-chain-arb', 'nft-market-maker'],
    stripePriceId: process.env.STRIPE_PRO_PRICE_ID || 'price_pro_test',
    limits: {
      maxSymbols: 10,
      allowLiveTrading: true,
      paperOnly: false,
      allowedExchanges: ['binance', 'kraken', 'coinbasepro', 'kucoin'],
      maxPerTradeUsd: 2000,
  ...
  },
  {
    ...
    limits: {
      ...
      allowLiveTrading: true,
      paperOnly: false,
      allowedExchanges: ['binance', 'kraken', 'coinbasepro', 'kucoin', 'bybit', 'okx'],
